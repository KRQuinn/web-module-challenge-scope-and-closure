...
/*Task 1: counterMaker()
  ...
  1. What is the difference between counter1 and counter2?
    One has closure, the other does not. Counter2's count variable is exposed globally.
...
//       let homeScore = 0;
//       let awayScore = 0;
//       const currentScore = majorLeague(inningCB);
...
function scoreboard(/* CODE HERE */) {
  ...
  //   homeScore = homeScore + currentScore.Home
  //   awayScore = awayScore + currentScore.Away
  //   mlbTotal.push(`"Inning: "${i} "Home": ${currentScore.Home} "Away": ${currentScore.Away}`);
  // }
